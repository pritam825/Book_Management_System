...
<div class="btn-group">
  ...
  <ul class="dropdown-menu dropdown-menu-end">
    ...
    <br>
    <br>
    <center><h1 style="font-family:cursive"><u>Manage Category</u></h1></center>
    <br>
    <br>
    <div class="row">
...
<?php
      ...
      while($row=mysqli_fetch_assoc($query_run))
      {
          ...
          <td><button class="btn" name=""><a href="edit_cat.php?cid=<?php echo $row['cat_id'] ?>">✏️</a></button>
          <button class="btn" name=""><a href="delete_cat.php?cid=<?php echo $row['cat_id'] ?>">❌</a></button></td>
          </tr>
          <?php
      }
?>
