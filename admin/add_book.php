...
<div class="btn-group">
  ...
  <ul class="dropdown-menu dropdown-menu-end">
    ...
    <br>
    <br>
    <center><h1 style="font-family:cursive"><u>Add New Book</u></h1></center>
    <br>
    <br>
    <div class="row">
        ...
        <div class="col-md-4">
           <form action="" method="post">
               ...
               <div class="form-group">
               <label for="">Book Author id:</label>
...
$status=$_POST['status'];
$query="INSERT INTO book(book_id,book_name,author_id,cat_id,book_no,status) VALUES(null,'$book_name','$book_author',$book_cat,$book_no,'$status')";
